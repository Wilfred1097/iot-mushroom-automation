...
if ($exportFormat === 'csv') {
    ...
    header('Content-Disposition: attachment; filename="parking_only_data.csv"');

    // Output CSV headers
    $output = fopen('php://output', 'w');
    fputcsv($output, array('id', 'vehicle_type', 'make_model', 'license_num', 'color', 'date_in', 'Time_in', 'payment_type', 'amount'));
